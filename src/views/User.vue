...
<!--      </div>-->
      ...
      <div class="user-center" v-if="Object.keys(this.$store.state.user).length !== 0">
        ...
        <div v-for="item in playlist" :key="item.index">
          <div v-if="item.creatorId === user.id && CreatedPlaylistsExpandOrCollapse === true">
        ...
        <div v-for="item in playlist" :key="item.index">
          <div v-if="item.creatorId !== user.id && CollectPlaylistsExpandOrCollapse">
            <UserSongListDesc :playlist="item"></UserSongListDesc>
          </div>
        </div>
        ...
        <div class="col-md-4 col-md-offset-4">
          ...
          <form action="#" class="fh5co-form animate-box" data-animate-effect="fadeIn">
            ...
            <div class="form-group">
              ...
              <input type="text" v-model="userEmail" class="form-control" id="userEmail" placeholder="Email" autocomplete="off">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
              ...
              <input type="submit" value="注册" class="btn btn-primary" @click="clickLRegister" style="margin-left: .3rem">
            </div>
          </form>
        </div>
      </div>
...
export default {
  ...
  methods: {
    ...
    getCreatePlayLists () {
      if (this.user !== '') {
        this.$axios.get(this.$localMusicApi + '/playlist/uid?uid=' + this.user.id).then(this.getCreatePlayListsSucc)
      }
    },
    ...
    clickLogin () {
      ...
      this.$axios.post(this.$localMusicApi + '/login', {
        email: this.userEmail,
        password: this.password
      }).then(this.getLoginUserInfoSucc)
    },
